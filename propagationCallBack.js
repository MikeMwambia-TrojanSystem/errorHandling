/*
In a callback based pattern the first argument is always the error object
*/
function doTask (amount, cb) {
    ...
    cb(Error('some other error')) //Insert some error for the sake of propagation
    cb(null, amount/2)
  }

  function run (cb) {
      //Notice how the call back is passed
    doTask(4, (err, result) => {
      if (err) {
